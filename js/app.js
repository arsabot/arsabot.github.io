 ...
 */
import { initI18n, getCurrentLang, onLanguageChange } from './i18n.js?v=4.5';
import { initTypewriter } from './typewriter.js?v=4.5';
import { initProjects } from './projects.js?v=4.5';
import { initStats, showToast } from './stats.js?v=4.5';
import { initHorizontalTimeline } from './timeline.js?v=4.5';
